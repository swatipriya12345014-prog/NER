...
const Vehicles = () => {
  ...
  const filteredVehicles = vehicles.filter((v) => {
    const matchesSearch =
      ...
      v.assigned_driver.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const handlePlanRoute = (vehicleId) => {
    navigate(`/live-map?vehicle=${vehicleId}&autoRoute=true`);
  };
          ...
          return (
            ...
            >
              <div>
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    <span className="text-[10px] font-mono font-bold text-blue-400 px-2 py-0.5 bg-blue-500/10 rounded-md border border-blue-500/20">
                ...
                <div className="mt-3 space-y-2 text-xs">
                  ...
                  <div className="flex items-center justify-between text-slate-300">
                    ...
                    <span className="font-medium text-slate-200 text-right">{vehicle.current_location}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-slate-300">
                    ...
                    <span className="font-medium text-slate-200">{vehicle.assigned_driver}</span>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-xs rounded-xl shadow-lg flex items-center justify-center space-x-2 transition-all active:scale-98 cursor-pointer mt-2"
              >
                <Navigation size={14} />
                <span>Calculate AI Shortest vs Safest Route</span>
                <ArrowRight size={13} />
              </button>
            </div>
          );
