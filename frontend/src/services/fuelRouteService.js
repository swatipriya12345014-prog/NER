...
export const FALLBACK_FLEET_VEHICLES = [
  ...
  {
    id: 'AS-01-GB-2024',
    name: 'Brahmaputra Heavy Relief Hauler',
  ...
  {
    id: 'AS-12-BC-7890',
    name: 'Sonitpur Cold-Chain Pharma Transporter',
  ...
  {
    id: 'AS-03-CC-5112',
    name: 'Kaziranga Sector Rapid Patrol',
  ...
  {
    id: 'AS-25-D-9981',
    name: 'Barak Valley Cryogenic Oxygen Transporter',
  ...
  {
    id: 'ML-08-E-4520',
    name: 'Garo Hills High-Clearance Logistics 4WD',
  ...
  {
    id: 'ML-05-MD-1108',
    name: 'Meghalaya Mobile Life Support',
    ...
    fuel_status: 'Adequate',
    assigned_driver: 'Bantei Kharbuki',
  ...
  {
    id: 'AR-01-TR-3312',
    name: 'BRO Vartak Strategic Heavy Hauler',
  ...
  {
    id: 'AR-11-AX-9005',
    name: 'Subansiri Rapid Disaster Response 4WD',
  ...
  {
    id: 'TR-05-MC-6712',
    name: 'North Tripura Emergency Relief Transporter',
  ...
  {
    id: 'MN-01-AB-5544',
    name: 'Imphal Civil Rapid Response Ambulance',
  ...
  {
    id: 'NL-07-CD-3310',
    name: 'Nagaland Emergency Rescue Unit',
  ...
  {
    id: 'NL-01-TR-8819',
    name: 'Naga Hills Mountain Logistics Truck',
    ...
    fuel_status: 'Adequate',
    assigned_driver: 'Kevichusa Angami',
  ...
  {
    id: 'MZ-01-GH-6622',
    name: 'Mizoram Mountain Logistics Van',
  ...
  {
    id: 'MZ-02-ER-3401',
    name: 'South Mizoram Medical Courier 4x4',
  ...
  {
    id: 'SK-04-TR-1299',
    name: 'Kanchenjunga Extreme Terrain Hauler',
...
export function searchFleetVehicles(query = '', inTransitOnly = false) {
  const qNorm = (query || '').trim().toLowerCase().replace(/[-\s]/g, '');
  return FALLBACK_FLEET_VEHICLES.filter((v) => {
    if (inTransitOnly && !v.is_in_transit && !v.status.toLowerCase().includes('transit')) return false;
    if (!qNorm) return true;
    const vNum = (v.vehicle_number || v.id || '').toLowerCase().replace(/[-\s]/g, '');
    const vPlate = (v.license_plate || '').toLowerCase().replace(/[-\s]/g, '');
    const vName = (v.name || '').toLowerCase();
    const vDriver = (v.assigned_driver || v.driver_name || '').toLowerCase();
    const vRoad = (v.current_road || '').toLowerCase();
    const vDest = (v.destination || '').toLowerCase();
    const vCargo = (v.cargo_manifest || '').toLowerCase();
    const vState = (v.state || '').toLowerCase();
    return vNum.includes(qNorm) || vPlate.includes(qNorm) || vName.includes(qNorm) ||
           vDriver.includes(qNorm) || vRoad.includes(qNorm) || vDest.includes(qNorm) ||
           vCargo.includes(qNorm) || vState.includes(qNorm);
  });
}
